     ...
     <div class="bg-white p-10 shadow-sm">
         <div class="">
            @if (is_null($aluno->image_path ))
                <img class="content-center" src="{{ asset('icons/no_photo.jpg') }}" width="150" height="150">
            @else
                <img class="content-center" src="{{ asset('images/' . $aluno->image_path) }}" width="150" height="150">
            @endif
         </div>
        ...
        <div class="accordion-content px-5 pt-0 overflow-hidden max-h-0">
           <div class="pb-6">
               ...
               <span class=" font-light pl-9 text-justify">
                       Nome do Pai: {{$aluno->aluno_pai }}
               </span>
               <br>
               <span class="leading-6 font-light pl-9 text-justify">
                        Nome da Mãe: {{ $aluno->aluno_mae }}
                </span>
           </div>
           <div class="pb-6">
         ...
         <!-- header -->
            ...
            <div class="accordion-content px-5 pt-0 overflow-hidden max-h-0">
                ...
                <div class="pb-4">
                    <h4 class="leading-6 pl-9 text-justify font-semibold">- Restrição Alimentar</h4>
                    <span class="leading-6 font-light pl-9 text-justify">
